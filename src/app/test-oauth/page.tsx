...
export default function TestOAuthPage() {
  ...
  const testBackendOAuth = async () => {
    ...
    try {
      const response = await fetch('https://regaloobyps.com/oauth2/authorization/google', {
        method: 'GET',
        redirect: 'manual'
      });
  ...
  const testDirectOAuth = () => {
    ...
    window.location.href = 'https://regaloobyps.com/oauth2/authorization/google?prompt=select_account';
  };
        ...
        <div className="space-y-6">
          <div className="p-4 bg-red-50 border border-red-200 rounded">
            ...
            <ol className="list-decimal list-inside text-sm text-red-700 space-y-1">
              ...
              <li>Add redirect URI: https://regaloobyps.com/login/oauth2/code/google</li>
