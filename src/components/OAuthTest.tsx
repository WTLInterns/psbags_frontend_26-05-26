...
const OAuthTest: React.FC = () => {
  ...
  const testBackendConnection = async () => {
    ...
    try {
      ...
      const response = await fetch('https://regaloobyps.com/auth/oauth2/success');
    ...
    try {
      ...
      const oauthResponse = await fetch('https://regaloobyps.com/auth/google', {
        method: 'GET',
  ...
  const testDirectOAuth = () => {
    ...
    window.location.href = 'https://regaloobyps.com/oauth2/authorization/google';
  };
