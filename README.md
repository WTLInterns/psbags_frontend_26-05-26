...
NEXT_PUBLIC_API_URL=https://api.regaloobyps.com
...
- Base URL derives from `process.env.NEXT_PUBLIC_API_URL` with a default `https://api.regaloobyps.com` (see `src/services/productService.ts`).
...
3. Start the dev server:
   ...
   npm run dev
   ```
4. Open https://api.regaloobyps.com
