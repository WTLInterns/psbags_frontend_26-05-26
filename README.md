...
NEXT_PUBLIC_API_URL=https://regaloobyps.com
...
- Base URL derives from `process.env.NEXT_PUBLIC_API_URL` with a default `https://regaloobyps.com` (see `src/services/productService.ts`).
